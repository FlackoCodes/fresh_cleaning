      ...
      <div className="container mx-auto px-6">
            ...
            <ul className="space-y-2">
              {services.map((service) => (
                <li key={service}>
                  <a
                    href="#services"
                    className="text-primary-foreground/70 hover:text-eco-gold text-sm transition-colors"
                  >
                    {service}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-primary-foreground/70 text-sm">
                <Phone className="h-4 w-4 text-eco-gold" />
                647-478-0831
              </li>
              <li className="flex items-center gap-2 text-primary-foreground/70 text-sm">
                <Mail className="h-4 w-4 text-eco-gold" />
                876elitefinishcleaning@gmail.com
              </li>
              <li className="flex items-center gap-2 text-primary-foreground/70 text-sm">
                <MapPin className="h-4 w-4 text-eco-gold" />
                Kingston, Jamaica
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 pt-8">
          <p className="text-center text-primary-foreground/60 text-sm">
            © 2026 876 Elite Finish Cleaning. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
